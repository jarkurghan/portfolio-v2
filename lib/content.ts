import type { BentoSize, Experience, Project, ProjectKind } from "./types";

export const site = {
  name: "Najmiddin Nazirov",
  role: "Full-stack dasturchi",
  tagline:
    "4 yillik tajribaga ega Full-stack dasturchiman. Hozir Buyuk Britaniyaning Carplus kompaniyasida asosiy frontend dasturchiman. Asosan saytning odam ko‘radigan qismi bilan ishlayman — tugma bosilgandan sahifa ochilgunicha. Ishdan tashqari o‘zimga kerak narsalarni qilaman: analitika, kichik web ilovalar, Telegram botlar.",
...
export const experience: Experience[] = [
  {
    ...
    points: [
      "UK avtomobil moliyasi brokeri: quote, katalog, landinglar va ichki CRM frontend.",
      "Asosiy frontend dasturchi: Next.js, Redux, SEO-og‘ir marketing saytlar va lead oqimi.",
      "Kampaniya subdomainlari, Autoconvert bilan bog‘liq CRM va yangi brend landinglari.",
    ],
  },
  {
    company: "Transoxania Technology Solutions",
    role: "Full-stack dasturchi",
    period: "2022-yil aprel — 2025-yil iyul",
    place: "O‘zbekiston",
    url: "https://www.transoxania.uz",
    points: [
      "O‘nlab web loyihalar: Node.js, Express, Knex, PostgreSQL, Redis; UI — React va Angular.",
      "Ba’zi loyihalarda obyekt modelini tayyorladim, ba’zilarida TeamLead bo‘ldim.",
      "Mehmonxona, HR/payroll, lug‘at va booking kabi real biznes tizimlari.",
    ],
  },
  {
    ...
    points: [
      "Maktab o‘qituvchilariga C++ va dasturlash asoslaridan qisqa kurs.",
    ],
  },
];
...
export const featuredBento: { slug: string; size: BentoSize }[] = [
  { slug: "tashrif", size: "lg" },
  { slug: "carplus", size: "md" },
  { slug: "sanoq", size: "md" },
  { slug: "githubchi", size: "sm" },
  { slug: "taxmin", size: "sm" },
  { slug: "hrp", size: "sm" },
];

export const featuredSlugs = featuredBento.map((item) => item.slug);
...
export const projects: Project[] = [
  {
    ...
    url: "https://carplus.co.uk/",
    summary:
      "UK avtomobil moliyasi brokerining asosiy sayti — quote, katalog, kalkulyatorlar va yuzlab SEO sahifalar.",
    purpose:
  ...
  },
  {
    ...
    summary:
      "PCP mahsuloti uchun alohida landing va quote — reklama kampaniyalaridan kelgan leadlarni api_key orqali ajratish.",
    purpose:
  ...
  },
  {
    ...
    kind: "ish",
    summary:
      "Saytdan kelgan leadlarni operatorlar ko‘radigan ichki panel — status, Autoconvert va statistika.",
    purpose:
  ...
  },
  {
    ...
    kind: "ish",
    summary:
      "UK biznes sug‘urtasi brokeri uchun landing — Carplus quote shablonidan fork, mahsulot hali o‘tish holatida.",
    purpose:
  ...
  },
  {
    ...
    summary:
      "O‘zbek izohli lug‘at — birinchi o‘z g‘oyam va o‘zim yozgan to‘liq loyiha.",
    purpose:
      "O‘zbek so‘zlarining ma’nolarini qidirish. Admin so‘z va izohlarni kiritadi, foydalanuvchi ochiq qidiruv kabi ishlatadi.",
    tasks: [
      "Admin: so‘z va ma’lumot kiritish.",
      "Foydalanuvchi: qidiruv va izohni o‘qish.",
      "API va UI ni boshidan yozish.",
    ],
  ...
  },
  {
    ...
    summary:
      "Mehmonxona ish kuni portali — mehmonlar bilan ishlashni elektronlashtirish.",
    purpose:
    ...
    tasks: [
      "Asosiy ish paneli va admin.",
      "Bron/mehmon oqimini backendda modellash.",
      "React Native urinishi (tugatilmagan).",
    ],
    stack: [
      "Node.js",
      "Express",
  ...
  },
  {
    ...
    summary:
      "Hotel portal uchun ochiq bron: internet orqali xona band qilish.",
    purpose:
      "Mehmonxona ichki tizimidan tashqari, tashqi foydalanuvchi ham xona band qila olsin. Ochiq dastur.",
    tasks: [
      "Xona qidiruv va band qilish oqimi.",
      "Hotel portal API bilan ishlash.",
      "Ommaviy UI.",
    ],
    stack: ["Node.js", "Express", "Knex", "React"],
    learned:
      "Ichki portal va ochiq booking ni ajratish: ruxsat, narx, mavjudlik. B2B tizimning B2C yuzini qanday chiqarish.",
  },
  {
    slug: "hrp",
    ...
    summary:
      "Kadrlar va buxgalteriya uchun yordamchi — xodim, lavozim, ko‘nikma, maosh. O‘ndan oshiq dasturga bo‘lingan.",
    purpose:
      "HR va payroll ishlarining elektron varianti: ishga olish, lavozim, ko‘nikmalar, maosh hisobi va yuzlab kichik jarayonlar.",
    tasks: [
  ...
  },
  {
    ...
    summary:
      "Yengil veb analitika: pageview, jonli panel, jamoa rollari va Telegram hisobotlari.",
    purpose:
  ...
  },
  {
    ...
    url: "https://sanoq.uz",
    summary:
      "Sanoq sistemalari konvertori, asosga mos kalkulyator va maqolalar — 13 til, hisobsiz.",
    purpose:
  ...
  },
  {
    ...
    summary:
      "Hisobsiz onlayn Markdown muharriri — chapda yozasiz, o‘ngda darhol ko‘rinadi.",
    purpose:
      "README, qayd, blog qoralamasini brauzerda yozish. Matn localStorage da; serverga kontent ketmaydi. Import/eksport `.md`.",
    tasks: [
      "Split-view, mobil yorliqlar, formatlash paneli.",
      "GitHub Flavored Markdown preview.",
      "UZ/EN sahifalar, tema, klaviatura yorliqlari.",
    ],
    stack: [
      "Next.js 16",
      "React 19",
  ...
  },
  {
    ...
    summary:
      "GitHub contribution graphiga tanlangan naqsh bo‘yicha sanalangan commitlar.",
    purpose:
  ...
  },
  {
    ...
    url: "https://taxmin.uz",
    summary:
      "FIFA JCH 2026 uchun hisob taxmin, ball va reyting — web, Mini App va bot.",
    purpose:
      "O‘yin oldidan bitta hisob yozish, tugagach avtomatik ball, boshqalar taxminiga izoh/emoji, reyting. Kirish Telegram orqali.",
    tasks: [
      "football-data.org dan o‘yinlar, ball qoidalari.",
      "Web + Telegram Mini App + grammY bot.",
      "JWT, Postgres, o‘yin tugagach e’lon.",
    ],
    stack: [
      "Next.js 15",
      "React 19",
  ...
  },
  {
    ...
    summary:
      "Sotilayotgan domenlar uchun bitta landing — host nomini o‘zi ko‘rsatadi, CTA Telegram.",
    purpose:
      "Parked sahifa: qaysi domen ochilsa, o‘sha nom chiqadi. Katalog/CMS yo‘q. Bir build ko‘p domenga.",
    tasks: [
      "Host header / hostname ni sarlavhada ko‘rsatish.",
      "Domen bo‘yicha tashrif clientId.",
      "Docker + standalone.",
    ],
    stack: ["Next.js 16", "React 19", "TypeScript", "tashrif"],
    learned:
      "Minimal landing, multi-tenant host, request-time Host. Keraksiz stack qo‘shmaslik — ba’zan CSS yetadi.",
  },
  {
    slug: "monitoring",
    ...
    year: "2025–2026",
    kind: "mahsulot",
    url: "https://monitor.jarkurghan.uz",
    summary:
      "O‘z Telegram botlarim statistikasini bitta dashboardda — botlarga yozmaydi, bazadan o‘qiydi.",
    purpose:
      "Namoz, Insta saver, Anime, Multfilm botlaridagi user, status, ko‘rish/yuklash raqamlarini grafikda ko‘rish. Ichki vosita.",
    tasks: [
      "To‘rt Postgres ulanish, faqat SELECT.",
      "Har bot uchun o‘ziga xos kartalar va Recharts.",
      "Hono API + Next.js server fetch.",
    ],
    stack: [
      "Next.js 16",
      "React 19",
  ...
  },
  {
    ...
    summary:
      "Tanlangan hudud va soatda har kuni namoz vaqtlarini yuboradigan Telegram bot.",
    purpose:
      "O‘zbekiston shaharlari uchun bomdod–xufton jadvali. islom.uz taqvimidan. Lotin/kirill, obuna, Ramazon qo‘shimchalari.",
    tasks: [
      "Hudud va tarqatma soatini sozlash.",
      "Kunlik scheduler, Playwright scraping.",
      "Admin log, blok holati.",
    ],
  ...
  },
  {
    ...
    summary:
      "Instagram post/reel havolasini yuborasiz — bot media ni Telegramga qaytaradi.",
    purpose:
      "Sahifani ochmasdan reels/postni chatga saqlash. Shaxsiy chat va guruh.",
    tasks: [
      "URL parse, media yuklash, media group.",
      "User/guruh statistikasi monitoring uchun.",
      "Webhook + Postgres.",
    ],
    stack: ["Bun", "grammY", "Hono", "PostgreSQL", "Drizzle", "axios"],
    learned:
      "Tashqi sayt o‘zgarishiga chidamli yuklash, guruh vs private farqi, rate va fayl hajmi. Foydalanish hisobini keyin dashboardga ulash.",
  },
  {
    slug: "anime-bot",
    title: "AniUZ bot",
    ...
    summary:
      "O‘zbekcha dub anime katalogi — qismni tanlaysiz, video shaxsiy chatga nusxalanadi.",
    purpose:
      "Kanal postlarini `copyMessage` qilib tomoshabinga yetkazish. Qidiruv, dub studiya, sahifalash.",
    tasks: [
      "Katalog, qism, dub tanlash UI (inline).",
      "User sahifa holati, deep link.",
      "Admin va statistika.",
    ],
    stack: ["Bun", "grammY", "Hono", "PostgreSQL", "Drizzle"],
    learned:
      "Katta inline menyu holati, Telegram file_id/copyMessage modeli. Kontent huquqi va kanal-bot juftligi. Qidiruv va pagination bot UX.",
  },
  {
    slug: "multik-bot",
    ...
    summary:
      "Kanalidagi kod orqali o‘zbekcha multfilmlarni olish; Netflix uslubidagi Mini App.",
    purpose:
      "Kod (masalan M319) yoki Mini App katalogidan tanlash — bot videoni shaxsiy chatga yuboradi. Kontent qo‘yish alohida operator botida.",
    tasks: [
      "Kod qidiruv, copyMessage.",
      "Hono katalog API + Next.js Mini App.",
  ...
  },
  {
    ...
    kind: "bot",
    summary:
      "Kanal jamoasi uchun operator bot: IMDb, post matni, kod, asosiy kanalga chiqarish.",
    purpose:
    ...
    tasks: [
      "IMDb scrape, Gemini tarjima.",
      "Film/serial rejimlari, kod generator.",
      "Faqat kanal administratorlari.",
    ],
    stack: [
      "Node.js",
      "grammY",
  ...
  },
  {
    ...
    summary:
      "Shaxsiy qarz daftari: kim oldi/berdi, qaytarish, muddat, ikkinchi tomon bilan ulashish.",
    purpose:
      "Do‘stlar o‘rtasidagi ovushni Telegramda yozish. Kontaktga Telegram shart emas. Ikkala tomon botda bo‘lsa, qarz sinxron.",
    tasks: [
      "Qarz/qaytarish, netting, yopilish.",
      "Eslatma soati, lotin/kirill.",
      "Ulashish tokeni.",
    ],
    stack: ["Bun", "grammY", "Hono", "PostgreSQL", "Drizzle"],
    learned:
  ...
  },
  {
    ...
    summary:
      "IMDb havolasini yuborasiz — meta ma’lumot va o‘zbekcha syujet qaytadi.",
    purpose:
      "Film sahifasini ochmasdan qisqa kartochka. Playwright + Gemini tarjima.",
    tasks: [
      "Title URL ni scrape qilish.",
      "Syujetni soddalashtirib tarjima.",
      "Typing action, admin log.",
    ],
    stack: ["grammY", "Playwright", "Gemini", "PostgreSQL"],
    learned:
      "Nozik scrape (`__NEXT_DATA__`), AI ni faqat tarjima uchun. Kutish UX. Tashqi sahifa o‘zgarsa bot sinishi — izolyatsiya.",
  },
  {
    slug: "video-meta-bot",
    ...
    summary:
      "Video yuborasiz — sifat, davomiylik, hajm, o‘lcham matn qilib qaytadi.",
    purpose:
      "Faylni qayta kodlamasdan Telegram metadatasini o‘qish. Tezkor tekshiruv vositasi.",
    tasks: [
      "`message.video` maydonlarini formatlash.",
      "Sifatni resolution dan taxmin qilish.",
    ],
    stack: ["grammY", "PostgreSQL"],
    learned:
      "Telegram file object yetarli bo‘lsa, ffmpeg shart emas. Kichik botni ham user/status modeliga solish (keyin monitoring).",
  },
  {
    ...
    summary:
      "Video + rasm juftligi — bot videoni shu rasm cover qilib qaytaradi.",
    purpose:
      "Kompyuterda transcode qilmasdan Telegram `cover` API. Kanal postlari uchun preview.",
    tasks: [
      "Sessiya: video keyin rasm yoki aksincha.",
      "Media group dan eng katta photo.",
    ],
    stack: ["grammY", "PostgreSQL"],
    learned:
      "Bot API ning tayyor imkoniyatini ishlatish. In-memory sessiya restart da yo‘qolishi — qachon Redis kerakligi.",
  },
  {
    slug: "eski-portfolio",
    ...
    summary:
      "Ikki yil oldingi shaxsiy sayt — HTML, CSS, JS, uch til. Backend yo‘q.",
    purpose:
      "Tajriba va loyihalarni bir sahifada ko‘rsatish. CMS/forma yo‘q.",
    tasks: [
      "Sticky sider layout, loyiha kartalari.",
      "`?lan=` bilan UZ/RU/EN.",
    ],
    stack: ["HTML", "CSS", "JavaScript"],
    learned:
      "Kontentni qo‘lda yangilamaslik qancha tez eskiradi. Hozirgi portfolio shu darsdan: ma’lumotni tuzilma qilib, yangi stackda qayta yozish.",
  },
  {
    slug: "mern-1",
    title: "Movies app",
    ...
    summary:
      "Netflix uslubidagi katalog: TMDB, treyler, Firebase, Stripe obuna. Bo‘sh vaqtda qiziqish.",
    purpose:
      "Katalog + to‘lov devorini o‘rganish. Haqiqiy streaming emas.",
    tasks: [
      "Auth, tarif tanlash, My List.",
      "TMDB qatorlari, YouTube treyler modal.",
    ],
    stack: [
      "Next.js 13",
      "React 18",
  ...
  },
  {
    ...
    summary:
      "OwlTop uslubidagi kurs sahifalari — ma’lumot `db.json`, to‘lov/login yo‘q.",
    purpose:
      "Landing, sidebar katalog, kurs kartasi, reyting, sharh UI sini mashq qilish.",
    tasks: [
      "getServerSideProps, CSS modules, Storybook.",
      "Sharh formasi (JSONPlaceholder).",
    ],
    stack: [
      "Next.js 13",
      "React 18",
    ...
    learned:
      "Dizayn tizimi, HOC layout, mock API. Nima ishlamasa ochiq yozish. Keyingi real mahsulotlarga qaraganda bu — UI mashq.",
  },
  {
    slug: "super-tour",
    title: "Super Tour",
    ...
    summary:
      "Sayohat agentligi landing — suhbatga borganimda sinov task. Bron tizimi emas.",
    purpose:
      "Hero, xizmat kartalari, i18n, ariza formasi namunasini vaqt ichida chiqarish.",
    tasks: [
      "EN/UZ/RU, sticky navbar.",
...
export function featuredProjects() {
  return featuredBento
    .map((item) => {
      const project = getProject(item.slug);
      return project ? { ...project, size: item.size } : null;
    })
    .filter((p): p is Project & { size: BentoSize } => Boolean(p));
}
